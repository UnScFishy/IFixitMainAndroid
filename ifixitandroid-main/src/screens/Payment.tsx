...
type PaymentScreenProps = {
  onNavigate: (screen: 'login' | 'home' | 'modules' | 'shop') => void;
...
const PaymentScreen: React.FC<PaymentScreenProps> = ({ onNavigate, setLoading, setAlert, user, booking, setBooking }) => {
  ...
  const getBooking = () => {
    ...
    axios.post(apiUrl, {
    ...
    },
      {
        ...
        console.log("PAYMENT:" , response.data.qrcode);
          ...
          <>
            <View style={styles.listItem}>
              ...
              {activeBooking.qrcode &&
                <Image
                  source={{ uri: activeBooking.qrcode }}
            ...
            </View>
            {
              ...
              <View style={{ flex: 1, flexDirection: 'row' }}>
                <TouchableOpacity style={styles.button} onPress={payBooking}>
                  <Text style={styles.buttonText}>Continue to Pay via QR Code</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.button} onPress={payBooking}>
                  <Text style={styles.buttonText}>Cash Payment</Text>
                </TouchableOpacity>
              </View>
            }
          </>
